...
class CustomerController extends Controller
{
    ...
    public function business_index(Request $request)
    {
        ...
        $sortMap = [
            ...
            'record_file_no' => ['column' => 'sort_details.record_file_no', 'joins' => ['details'], 'empty_last' => true],
    ...
    public function storeBusiness(Request $request)
    {
        ...
        try {
            ...
            $details->fill([
                ...
                'default_shipping_method' => $request->input('default_shipping_method', 'transport'),
    ...
    public function update(Request $request, $id)
    {
        ...
        $details->fill([
            ...
            'transport' => $transportSelection['transport'],
            'booked_to' => $transportSelection['booked_to'],
            'default_shipping_method' => $request->input('default_shipping_method', $details->default_shipping_method ?? 'transport'),
