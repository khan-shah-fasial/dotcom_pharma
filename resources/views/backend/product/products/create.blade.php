                                ...
                                @endif
                                    ...
                                    <div class="col-xxl-12 col-xl-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="role_label" value="{{ old('role_label') }}" placeholder="{{ translate('Role') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="schedule" value="{{ old('schedule') }}" placeholder="{{ translate('Schedule') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <select class="form-control aiz-selectpicker @error('unit') is-invalid @enderror"
                                                        name="unit"
                                                        data-live-search="true"   {{-- enables search --}}
                                                        title="{{ translate('Select a unit') }}"
                                                        required>

                                                    <!-- Weight Units -->
                                                    <optgroup label="Weight Units">
                                                        <option value="mcg" {{ old('unit') == 'mcg' ? 'selected' : '' }}>Microgram (mcg)</option>
                                                        <option value="mg" {{ old('unit') == 'mg' ? 'selected' : '' }}>Milligram (mg)</option>
                                                        <option value="g" {{ old('unit') == 'g' ? 'selected' : '' }}>Gram (g)</option>
                                                        <option value="kg" {{ old('unit') == 'kg' ? 'selected' : '' }}>Kilogram (kg)</option>
                                                        <option value="ng" {{ old('unit') == 'ng' ? 'selected' : '' }}>Nanogram (ng)</option>
                                                    </optgroup>

                                                    <!-- Volume Units -->
                                                    <optgroup label="Volume Units">
                                                        <option value="ml" {{ old('unit') == 'ml' ? 'selected' : '' }}>Milliliter (mL)</option>
                                                        <option value="ltr" {{ old('unit') == 'ltr' ? 'selected' : '' }}>Liter (L)</option>
                                                        <option value="cc" {{ old('unit') == 'cc' ? 'selected' : '' }}>Cubic Centimeter (cc)</option>
                                                        <option value="tsp" {{ old('unit') == 'tsp' ? 'selected' : '' }}>Teaspoon (tsp ≈ 5 mL)</option>
                                                        <option value="tbsp" {{ old('unit') == 'tbsp' ? 'selected' : '' }}>Tablespoon (tbsp ≈ 15 mL)</option>
                                                        <option value="fl_oz" {{ old('unit') == 'fl_oz' ? 'selected' : '' }}>Fluid Ounce (fl oz ≈ 30 mL)</option>
                                                    </optgroup>

                                                    <!-- Count Units -->
                                                    <optgroup label="Count Units">
                                                        <option value="pc" {{ old('unit') == 'pc' ? 'selected' : '' }}>Piece (Pc)</option>
                                                        <option value="tab" {{ old('unit') == 'tab' ? 'selected' : '' }}>Tablet (Tab)</option>
                                                        <option value="cap" {{ old('unit') == 'cap' ? 'selected' : '' }}>Capsule (Cap)</option>
                                                        <option value="amp" {{ old('unit') == 'amp' ? 'selected' : '' }}>Ampoule (Amp)</option>
                                                        <option value="vial" {{ old('unit') == 'vial' ? 'selected' : '' }}>Vial</option>
                                                        <option value="syringe" {{ old('unit') == 'syringe' ? 'selected' : '' }}>Syringe</option>
                                                    ...
                                                    <optgroup label="Special Units">
                                                        <option value="iu" {{ old('unit') == 'iu' ? 'selected' : '' }}>International Unit (IU)</option>
                                                        <option value="meq" {{ old('unit') == 'meq' ? 'selected' : '' }}>Milliequivalent (mEq)</option>
                                        ...
                                        <!-- Product HSN / HS Code  -->
                                        <div class="form-group row">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Product HSN')}} </label>
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control @error('product_hsn') is-invalid @enderror" name="product_hsn" value="{{ old('product_hsn') }}" placeholder="{{ translate('Product HSN Code') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control @error('product_hs') is-invalid @enderror" name="product_hs" value="{{ old('product_hs') }}" placeholder="{{ translate('Product HS Code') }}">
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <small class="text-muted">
                                            {{ translate('These images and videos are visible in the product details gallery. Minimum image dimensions: 900px × 900px. Accepted video formats: MP4, WEBM.') }}
                                        </small>
                                    </div>
                                </div>
                                <!-- Thumbnail Image -->
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="meta_keyword" value="{{ old('meta_keyword') }}" placeholder="{{ translate('Meta Keyword') }}">
                                    </div>
                                </div>
                                <!-- Meta Hashtag -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control aiz-tag-input" name="meta_hashtag[]" value="{{ old('meta_hashtag') }}" placeholder="{{ translate('Type and hit enter to add a hashtag') }}">
                                    </div>
                                </div>
                                <!-- Meta Caption -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="meta_caption" rows="4" class="form-control">{{ old('meta_caption') }}</textarea>
                                    </div>
                                </div>
                                <!--Meta Image -->
                                <div class="form-group row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        function initTreeSelections(treeSelector, selectedMain, selectedIds) {
        ...
        initTreeSelections('#treeview-category', '{{ old("category_id") }}', @json(old("category_ids", [])));
        initTreeSelections('#treeview2-group', '{{ old("group_id") }}', @json(old("group_ids", [])));
    });
