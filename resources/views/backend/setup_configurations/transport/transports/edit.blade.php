            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="mode" class="form-control aiz-selectpicker" required>
                        <option value="surface" @selected(old('mode', $transport->mode) === 'surface')>{{ translate('Surface') }}</option>
                        <option value="sea" @selected(old('mode', $transport->mode) === 'sea')>{{ translate('Sea') }}</option>
                        <option value="air" @selected(old('mode', $transport->mode) === 'air')>{{ translate('Air') }}</option>
                    </select>
