                ...
                @canany(['view_all_customers','view_classified_products','view_classified_packages'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customers.business', ['sort_by' => 'crm_id', 'sort_order' => 'asc']) }}" class="aiz-side-nav-link">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_all_contacts')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('prescription_enquiry') }}?type=prescription"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['prescription_enquiry']) }}">
