            ...
            <form id="reg_model_form_2" action="{{ url(route('new.user.account.create', ['param' => 'registration-bussiness-details'])) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="btn-group d-flex" role="group" aria-label="Type selection">
                        ...
                        @if(Session::has('reg_locality') && Session::get('reg_locality') == 'domestic') checked @endif
                        ...
                        @if(Session::has('reg_locality') && Session::get('reg_locality') == 'international') checked @endif
                        onclick="toggleLocalityFields();">
                        International</label>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        minlength="15" maxlength="15" placeholder="Please Enter IEC.No" >
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="registration_date" name="registration_date"
                                    class="form-control form-control-lg" value="{{ $data['registration_date'] ?? '' }}" required />
                            </div>
                        ...
                        <div class="locality-base-domestic"> 
                            <div class="col-md-12 mb-md-4 mb-3">
                                ...
                                <div class="form-group mb-1">
                                    <label class="form-label" for="gstin_uin_current_status">GSTIN Status / Current Status *</label>
                                    <input type="text" id="gstin_uin_current_status" name="gstin_uin_current_status"
                                        class="form-control form-control-lg" value="{{ $data['gstin_uin_current_status'] ?? $session_data_user['gstin_uin_current_status'] ?? '' }}" required placeholder="Enter GSTIN Status / Current Status"/>
                                </div>
                        ...
                        <div class="locality-base-international d-none"> 
                            <div class="col-md-12 mb-md-4 mb-3">
                                ...
                                <div class="form-group mb-1">
                                    <label class="form-label" for="gstin_uin_current_status">UIN Status / Current Status *</label>
                                    <input type="text" id="gstin_uin_current_status" name="gstin_uin_current_status"
                                        class="form-control form-control-lg" value="{{ $data['gstin_uin_current_status'] ?? $session_data_user['gstin_uin_current_status'] ?? '' }}" placeholder="Enter UIN Status / Current Status"/>
                                </div>
...
<div class="modal fade login_form_popup" id="reg_model_3" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content py-3">
            ...
            <form id="reg_model_form_2" action="{{ url(route('new.user.account.create', ['param' => 'registration-personal-details'])) }}"
                method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        @if($session_data_user['type_option'] == "domestic")
                            <div class="locality-base-domestic col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            minlength="12" maxlength="12" placeholder="Please Enter Aadhaar No" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 mb-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            minlength="12" maxlength="12" placeholder="Please Enter PAN No" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 mb-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            minlength="15" maxlength="15" placeholder="Please Enter Passport No" >
                                        </div>
                                    </div>
