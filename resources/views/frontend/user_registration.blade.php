                ...
                <div class="col-12 col-lg-12 col-xl-12">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form id="user-info" action="{{ url(route('create.new.user.registration')) }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email_id" name="email_id" class="form-control form-control-lg" required />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="ad_contact_number" name="ad_contact_number" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="land_mark_village" name="land_mark_village" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="district" name="district" class="form-control form-control-lg" required/>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country__code" name="country__code" class="form-control form-control-lg" required/>
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="phone_no_1" name="phone_no_1" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="phone_no_2" name="phone_no_2" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="whats_app_no" name="whats_app_no" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="gst_no" name="gst_no" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cc_no" name="cc_no" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="d_l_no_1" name="d_l_no_1" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="d_l_no_2" name="d_l_no_2" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="d_l_no_3" name="d_l_no_3" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="d_l_exp_Date" name="d_l_exp_Date" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="transport" name="transport" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cargo" name="cargo" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="booked_to" name="booked_to" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="branch_no" name="branch_no" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="branch_code" name="branch_code" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="ifsc_code" name="ifsc_code" class="form-control form-control-lg" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="micr_code" name="micr_code" class="form-control form-control-lg" />
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer_care_executive" name="customer_care_executive" class="form-control form-control-lg" />
                                        </div>
