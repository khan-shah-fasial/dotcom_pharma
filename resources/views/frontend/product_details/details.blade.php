...
<div class="text-left product_disc_text">
    ...
    <div class="row ml-0 mr-0 pt-4">
        ...
        <div class="col-md-4 pl-md-0 mb-md-0 mb-2">
            ...
            <span class="fw-500 fs-14 detail-red-color">{{ $detailedProduct->prescription_req == 1 ? 'Yes' : 'No'
                }}</span>
        </div>
        @endif
        ...
        <div class="col-12 pl-0 mt-3 pb-0">
            <span class="text-secondary fs-14"><span id="per-piece-price-product-details" class=""> </span> <span
                    class="per-piece-price-product-details-gst">incl. GST</span> / Piece</span>
        ...
        <div class="col-12 pl-0 mt-3 pb-0">
            ...
            <span class=" fs-18 text-center" style="color: #E31E24 !important;"><span
                    class="detail-font-14px detail-gray-color">You Save: </span> <span id="tax-product-details"
                    class="fs-18 text-center" style="color: #E31E24 !important;"></span> ({{
                discount_in_percentage($detailedProduct) }}%)</span>
            @endif
        </div>
        ...
        <div class="col-12 pl-0 pb-0">
            ...
            <form id="option-choice-form">
                ...
                <div
                    class="row no-gutters mt-3 @if (strtolower(get_single_attribute_name($choice->attribute_id)) == 'role') div_disable @endif">
                    ...
                    <div class="col-sm-10">
                        <div class="aiz-radio-inline">
                            ...
                            <label class="aiz-megabox pl-0 mr-1 mb-2" data-toggle="tooltip"
                                ...
                                <input type="radio" name="color" value="{{ get_single_color_name($color) }}" @if
                                    ($key==0) checked @endif>
                                <span
                ...
                <div class="row no-gutters">
                        ...
                        <div class="">
                            <div class="product-quantity d-flex align-items-center">
                                <div class="row no-gutters align-items-center aiz-plus-minus mr-3"
                                    ...
                                    <button class="btn col-auto btn-icon btn-sm btn-light rounded-0 new-bg-color"
                    ...
                    <div class="col-md-9 col-12 pl-0 mt-3 pb-0">
                        ...
                        <div class="" id="chosen_price_div">
                            <div class="">
                                <div class="fw-500 fs-14 text-dark mt-2 mb-2">{{ translate('Total Amount Product Wise')
                                    }}:</div>
                            </div>
                            <div class="">
        ...
        <div class="mt-4">
            ...
            <button type="button"
                ...
                @if (Auth::check() || get_Setting('guest_checkout_activation')==1) onclick="addToCart()" @else
        ...
        <div class="col-12 d-flex flex-wrap mt-4 pt-4 pb-2 pl-4 pr-2 detail-border-1px bg-white">
                ...
                <div class="detail-product-specs rounded h-100">
                    ...
                    <div class="display_flex3">
                        <div class=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-copy-check-icon lucide-copy-check">
                                <path d="m12 15 2 2 4-4" />
                                <rect width="14" height="14" x="8" y="8" rx="2" ry="2" />
                                <path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" />
                            </svg></div>
                        <div class=""><span class="detail-font-14px detail-gray-color">{{ translate('Pharma Categories')
                                }}:</span><br>
                            <span class="fw-500 fs-14">{{ $detailedProduct->pharma_categories ?? '-' }}</span>
                        </div>
                    </div>
            ...
            <div class="col-md-12 pl-0  mb-md-3 mb-3">
                <div class="detail-product-specs rounded h-100">
                    ...
                    <div class="display_flex3">
                        ...
                        <div class=""> <span class="detail-font-14px detail-gray-color">{{ translate('Product Form')
                                }}:</span><br>
                            <span class="fw-500 fs-14">{{ $detailedProduct->product_form ?? '-' }}</span>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 pl-0 mb-3">
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        <div class=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="col-12 col-md-6 pl-0 mb-3">
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            <p class="detail-font-14px detail-gray-color mb-0">{{ translate('Country of Origin') }}:</p>
            ...
            <div class="col-12 col-md-6 pl-0 mb-3">
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            <p class="detail-font-14px detail-gray-color mb-0">{{ translate('HSN / HS Code') }}:</p>
                ...
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            ...
                            <p id="dimentions-product-details pl21" class="fw-500 fs-14 mb-0"></p>
                        </div>
                    </div>
                ...
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            ...
                            <p id="weight-volume-product-details pl21" class="fw-500 fs-14 mb-0"></p>
                        </div>
                    </div>
                ...
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            ...
                            <p class="fw-500 fs-14 mb-0 pl21">{{ str_replace(',', ', ', $detailedProduct->tags) }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <button
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                ...
                <g id="Group_23918" data-name="Group 23918" transform="translate(1053.151 256.688)">
                    ...
                    <path id="Path_3014" data-name="Path 3014" d="M131.349,93.312h5a.5.5,0,0,1,0,1h-5a.5.5,0,0,1,0-1"
                        transform="translate(-1181 -343.5)"
                        fill="{{ get_setting('secondary_base_color', '#ffc519') }}" />
                    <path id="Path_3015" data-name="Path 3015" d="M131.349,99.312h5a.5.5,0,1,1,0,1h-5a.5.5,0,1,1,0-1"
...
<div class="delivery_section">
    ...
    <div class="delivery_boxex">
        <div class="delivery_boxex_img"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                stroke-linejoin="round" class="lucide lucide-shield w-6 h-6 text-medical-info">
                <path
    ...
    <div class="delivery_boxex">
        <div class="delivery_boxex_img"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-award w-6 h-6 text-medical-info">
                <path
    ...
    <div class="delivery_boxex">
        <div class="delivery_boxex_img"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" class="lucide lucide-rotate-ccw w-6 h-6 text-medical-info">
...
<div class="row no-gutters mt-3 d-none">
    ...
    <div class="col-sm-10">
        ...
        <a href="{{ route('returnpolicy') }}" class="text-blue hov-text-primary fs-14 ml-3" target="_blank">{{
...
<div class="modal fade" id="productEnquiryModal" tabindex="-1" role="dialog" aria-labelledby="productEnquiryModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="product_enquiry_store" class="form-default" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Enter Name') }}"
                            name="name" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="email" class="fs-16 fw-700 text-soft-dark">{{ translate('Email') }} <span
                                class="text-danger">*</span></label>
                        <input type="email" class="form-control rounded-0" placeholder="{{ translate('Enter Email') }}"
                            name="email" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="phone" class="fs-16 fw-700 text-soft-dark">{{ translate('Phone no.') }} <span
                                class="text-danger">*</span></label>
                        <input type="tel" class="form-control rounded-0" placeholder="{{ translate('Enter Phone') }}"
                            name="phone" required>
                    </div>
                    ...
                    {{-- <div class="form-group">
                        <label for="pincode" class="fs-16 fw-700 text-soft-dark">{{ translate('Pincode') }} <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Enter Pincode') }}"
                            name="pincode" required>
                    </div> --}}

                    <!-- Query -->
                    <div class="form-group">
                        <label for="query" class="fs-16 fw-700 text-soft-dark">{{ translate('Tell us about your query')
                            }}<span class="text-danger">*</span></label>
                        <textarea class="form-control rounded-0" placeholder="{{ translate('Type here...') }}"
                    ...
                    <div class="mt-4 text-right">
                        ...
                        @else
                        <button type="submit" class="btn btn-primary fw-700 fs-16 rounded-0 w-200px">{{
