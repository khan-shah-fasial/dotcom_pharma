...
<div class="text-left">
    ...
    <!-- Drug Name -->
    @if($detailedProduct->drug_name && !empty($detailedProduct->drug_name))
    ...
    <div class="row">
        ...
        <div class="col-12 mt-1">
            ...
            @if (discount_in_percentage($detailedProduct) > 0)
                <span class=" ml-0 fs-16 fw-400 text-white w-35px text-center p-1"
                    style="color: #E31E24 !important;">-{{ discount_in_percentage($detailedProduct) }}%less</span>
            @endif

            <span class="text-secondary fs-14"><span id="per-piece-price-product-details"
                    class="text-primary fs-24 font-600"> </span> / Piece</span>

            @if($detailedProduct->product_count && !empty($detailedProduct->product_count))
