...
<div class="text-left product_disc_text">
    ...
    <div class="row">
        <div class="col-xl-2 col-lg-3 col-12 pr-0">
            @if (!empty($detailedProduct->drug_name))
                <p class="mb-0 detail-gray-color fs-14">
                    <span class="text-muted">{{ translate('Drug Name') }}</span>
                </p>
            @endif
        </div>

        <div class="col-xl-9 col-lg-8 col-12 px-lg-0">
            @if (!empty($detailedProduct->drug_name))
                <p class="mb-0 detail-gray-color fs-14">
    ...
    <div class="row ml-0 mr-0 pt-md-4 pt-0">
        ...
        @if (!empty($detailedProduct->brand->name))
            <div class="col-md-6 col-6 pl-0 mb-md-0 mt-2">
        ...
        <div class="line mt-md-4 mt-3 mb-md-2 mb-3"></div>
    ...
    <div class="col-12 mt-2">
        ...
        <div class="line mt-md-4 mt-2 mb-md-2 mb-3"></div>


        <div class="col-12 d-flex flex-wrap mt-md-4 mt-3 pt-4 pb-2 pl-md-4 pl-3 pr-md-2 pr-0 detail-border-1px bg-white">
            <div class="col-12 col-md-12 text-left pl-0 pr-0">
                ...
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            ...
                            <p id="batch-lot-number" class="fw-500 fs-14 mb-0">AEJ-1301H@3</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 pl-0 mb-3">
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        ...
                        <div class="">
                            <p class="detail-font-14px detail-gray-color mb-0">{{ translate('Minimum Order Qty:') }}:
                            </p>
                            <p id="min-order-qty-product-details" class="fw-500 fs-14 mb-0">06</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 d-flex flex-wrap mt-4 pt-4 pb-2 pl-md-4 pl-3 pr-md-2 pr-0 detail-border-1px bg-white">
                    ...
                    <div class="col-6 col-md-6 pl-0 mb-3">
                        <div class="detail-product-specs rounded h-100">
                            <div class="display_flex3">
                                ...
                                <div class="">
                                    <p class="detail-font-14px detail-gray-color mb-0"> {{ translate('Category') }}:
                                    </p>
                    ...
                    <div class="detail-product-specs rounded h-100">
                        <div class="display_flex3">
                            ...
                            <div class="">
                                ...
                                <p class="fw-500 fs-14 mb-0">VI</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-6 pl-0 mb-3">
                        <div class="detail-product-specs rounded h-100">
                            <div class="display_flex3">
                                ...
                                <div class="">
                                    <p class="detail-font-14px detail-gray-color mb-0">{{ translate('Type') }}:
                                    </p>
                ...
                <div class="col-12 col-md-6 pl-0 mb-3">
                    <div class="detail-product-specs rounded h-100">
                        <div class="display_flex3">
                            ...
                            <div class="">
                                <p class="detail-font-14px detail-gray-color mb-0">Material</p>
                                <p class="fw-500 fs-14 mb-0">Liquid</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-12 text-left pl-0 pr-0">
                <h5 class="fe-semibold mb-3">Taz And Origin Details</h5>
            </div>
            ...
            <div class="col-12 col-md-6 pl-0 mb-3">
                <div class="detail-product-specs rounded h-100">
                    <div class="display_flex3">
                        <div class=""><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="">
                            ...
                            <p class="fw-500 fs-14 mb-0 pl21">5%</p>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-12 text-left pl-0 pr-0">
                <h5 class="fe-semibold mb-3">Packing Details</h5>
            </div>
