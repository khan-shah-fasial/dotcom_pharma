...
@section('content')
            ...
            <div class="home-slider slider-full">
                <div class="d-block mw-100 img-fit overflow-hidden overflow-hidden">
                    <img class="img-fit m-auto has-transition ls-is-cached lazyloaded"
                        src="{{ static_asset('assets/img/veterniry-banner-background.webp') }}" />
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="mb-4 mb-lg-5 mb-md-4 mt-4 mt-lg-5 mt-md-4">
            <div class="container">
                ...
                <div class="bg-white px-sm-3 top-category-product-sec">
                    <div class="aiz-carousel sm-gutters-17 top-category-product-carousel" data-items="7" data-xxl-items="7"
                        data-xl-items="7" data-lg-items="5" data-md-items="4" data-sm-items="2" data-xs-items="2"
                                        ...
                                        <div class="w-xl-auto position-relative hov-scale-img overflow-hidden p-1">
                                            ...
                                            <div class="w-100 d-flex flex-column align-items-center justify-content-end">
                                                <div class="w-100 text-center pt-1 pt-md-3">
                                                    <p
                                                        class="pb-0 mb-0 w-100 fs-18 fw-500 black_light_clr animate-underline-white home-category-name d-flex align-items-center justify-content-center hov-column-gap-1">
                                                        {{ $category_name }}
                                                    </p>
                                                    <p class="fs-14 fw-500 blue_light_clr mb-2">{{ $items_count }} Items
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @foreach ($banner_2_imags as $key => $value)
                        <div class="carousel-box overflow-hidden hov-scale-img">
                            <a href="{{ isset(json_decode($home_banner2_links, true)[$key]) ? json_decode($home_banner2_links, true)[$key] : '' }}"
                                style="border-radius:20px;" class="d-block text-reset overflow-hidden">
                                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                    data-src="{{ uploaded_asset($value) }}" alt="{{ env('APP_NAME') }} promo"
                                    class="img-fluid lazyload w-100 has-transition"
                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
    ...
    @endphp
    <div id="todays_deal" class="d-none"
    ...
    <section class="sale_section position-relative">
        <div class="image-wrapper">
            ...
            <a href="#" class="btn" data-toggle="modal" data-target="#exampleModal">
                <img src="{{ static_asset('assets/img/play_button_icon.webp') }}"
                    class="pulse-button space_1 overlay-img" alt="Play button">
            </a>
        </div>

        <div class="modal fade bd-example-modal-lg in mt-md-4 mt-5 p-3" id="exampleModal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div>
                        <button type="button"
                            class="close position-absolute right-0 p-1 pluse-button-pop-up d-flex justify-content-center align-items-center"
                            data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><img alt="close"
                                    src="{{ static_asset('assets/img/lightbox-close.png') }}"
                                    class="lightbox-close"></span>
                        </button>
                    </div>
                    <div class="modal-body m-0 p-0">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/0PHBJvkiQOM"
                                allowfullscreen>
                            </iframe>
                        </div>
                    </div>
                        ...
                        @if (get_setting('best_selling') == 1 && count($best_selling_products) > 0)
                            <section class="mb-2 mb-md-3 mt-2 mt-md-3">
                                <div class="container">
                                    ...
                                    <!-- Product Section -->
                                    <div class="px-sm-3">
                                        <div class="aiz-carousel sm-gutters-16 arrow-none vertical-slider" data-items="3"
                                            data-xl-items="3" data-lg-items="1" data-md-items="3" data-sm-items="2"
                                            data-xs-items="2" data-arrows='true' data-infinite='false'
                                            data-vertical="true">
                                            @foreach ($best_selling_products as $key => $product)
                                                <div
                                                    class="carousel-box px-0 position-relative has-transition @if ($key == 0)  @endif">
                                                    @include(
                                                        'frontend.' .
    ...
    @endphp
    @if ($flash_deal != null)
        <section class="flash_deals_section mt-md-5 mt-2 pt-md-5 pt-4 pb-md-5 pb-4 "
            style="background-image: url('{{ static_asset('assets/img/bg_deals_images.png') }}');">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12">
                        ...
                        <p>This week at <b>Pharm Vet Easy,</b> we bring you unbeatable discounts on top-quality veterinary
                            products. Whether you need premium pet supplements, livestock medications, or healthcare
                            essentials, our <b>Best Deal of the Week</b> ensures you get the best value for your money.
                        </p>
        ...
        <div class="container">
            <div class="row align-items-md-center">
                ...
                <div class="col-md-6 pl-md-5">
                    ...
                    <p>At <b>Pharm Vet Easy,</b> we have a strong vision for the future of global pharmaceuticals, with a
                        primary focus on high-quality veterinary formulations. Guided by our core values of <b>PEOPLE –
                            TRUST – VALUE & TECHNOLOGY,</b> we are committed to delivering world-class products and services
                        while ensuring cost-effectiveness.
                    </p>
                    <p class="mb-3">Established in 2000 in Mumbai, the financial hub of India, <b>Pharm Vet Easy</b> has
                        built a reputation as a trusted manufacturer and supplier of premium veterinary formulations. The
                        driving force behind our success is Mr. A.Y. Jaliawala, a Computer Engineer with extensive
                        experience in the pharmaceutical industry, whose expertise and leadership continue to shape our
                        journey toward excellence in animal healthcare.</p>
                    {{-- <!-- <ul class="list_none">
                    ...
                    <div class="mt-3">
                        <a href="/about-us" class="animate_button black1_buttons">Discover More <i
    ...
    <section class="why_choose_us pt-md-5 pb-md-5 pt-4 pb-4">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <p>At <b>Pharm Vet Easy,</b> provides top-quality veterinary products for animal health and well-being.
                        We prioritize reliability, innovation, and affordability for veterinarians, pet owners, and farmers.
                    </p>
                </div>
                ...
                <div class="col-md-4">
                    <div class="whu_choose_box mt-md-5 mt-3">
                        ...
                        <div class="">
                            ...
                            <p class="mb-0">Pharm Vet Easy offers 100% authentic veterinary medicines and pet care
                                products for your pet’s health.</p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="whu_choose_box mt-md-5 mt-3">
                        ...
                        <div class="">
                            ...
                            <p class="mb-0">We offer quality pet care at competitive prices, ensuring premium products
                                remain budget-friendly.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="whu_choose_box mt-md-5 mt-3">
                        ...
                        <div class="">
                            <h4>Free Shipping</h4>
                            <p class="mb-0">Enjoy free shipping with no hidden fees! Get your pet’s essentials delivered
                                quickly and securely to your doorstep.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="testimonials gray_bg pt-md-5 pb-md-5 pt-4 pb-4"
        style="background-image: url('{{ static_asset('assets/img/testi_bg.png') }}');">
        <div class="container">
            <div class="text-center">
                <p class="text-white mb-0">TESTIMONIALS</p>
                <h3 class="text_clr_green pb-md-4 pt-md-3 pb-2 text-white headeing_size">What Our Client Say’s About Us
                </h3>
            </div>
            ...
            <div id="customers-testimonials" class="slick-slider">
                ...
                <div class="item">
                    <div class="shadow-effect">
                        ...
                        <p class="pt-4">Pharm Vet Easy has been our go-to provider for veterinary medicines and
                            supplements. The quality of their products is outstanding, and their prompt delivery ensures our
                            clinic never runs out of essential supplies. Highly recommended!</p>
                ...
                <div class="item">
                    <div class="shadow-effect">
                        ...
                        <p class="pt-4">Is a livestock farmer, I need reliable and effective veterinary products. Pharm
                            Vet Easy has consistently provided top-notch solutions that keep my animals healthy. Their
                            customer service is excellent, making them a trusted partner in animal care.</p>
                        <div class="rating1 text-left">
                            <i class="las la-star"></i>
                            <i class="las la-star"></i>
                            <i class="las la-star"></i>
                ...
                <div class="item">
                    <div class="shadow-effect">
                        ...
                        <p class="pt-4">What sets Pharm Vet Easy apart is their knowledgeable team and dedication to
                            customer satisfaction. They helped me choose the right supplements for my pet, and I’ve seen
                            remarkable improvements in my dog's health. Thank you for the great service!</p>
                        <div class="rating1 text-left">
                            <i class="las la-star"></i>
                            <i class="las la-star"></i>
                            <i class="las la-star"></i>
                        ...
                        <div class="card mb-0">
                            <div class="accordion-item">
                                ...
                                <div id="collapse_1" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Pharm Vet Easy is a trusted provider of high-quality
                                        veterinary
                                        pharmaceuticals and healthcare solutions. We specialize in finished formulations
                                        for
                                        pets, livestock, and other animals, ensuring their health and well-being.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_2" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">We offer a wide range of veterinary products, including
                                        medicines, supplements, nutritional support, and healthcare essentials for
                                        various
                                        animals.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_3" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Yes, all our products are sourced from reputed
                                        manufacturers
                                        and comply with international quality and safety standards.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_4" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Yes, we cater to veterinary clinics, hospitals, and
                                        livestock
                                        farms with bulk supply options at competitive prices.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_5" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">You can place an order through our website or contact
                                        our
                                        customer support team for assistance with bulk or customized orders.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_6" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Yes, we provide global shipping options. Delivery times
                                        may
                                        vary based on location and regulatory approvals.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapse_7" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Once your order is dispatched, you will receive a
                                        tracking ID
                                        via email or SMS to monitor the shipment’s status.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_8" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">We accept multiple payment methods, including
                                        credit/debit
                                        cards, net banking, and digital payment gateways.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_9" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">Returns and exchanges are subject to our return policy.
                                        Please
                                        refer to our return policy section or contact customer support for details.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_10" class="collapse" data-parent="#accordion">
                                    <div class="card-body fs-14">You can reach our customer support team via email,
                                        phone, or
                                        our website’s contact form for any queries or assistance.
                                    </div>
                                </div>
                            </div>
