...
<a href="javascript:void(0)" class="d-flex align-items-center h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <i class="las la-shopping-bag la-2x" style="color:#23780E;"></i>
