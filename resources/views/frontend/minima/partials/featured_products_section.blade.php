    ...
    <section class="mb-2 mb-md-3">
        <div class="container">
            <div class="border border-primary overflow-hidden">
                ...
                <!-- Products Section -->
                <div class="px-sm-3">
                    <div class="aiz-carousel sm-gutters-15 arrow-none" data-items="5" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
